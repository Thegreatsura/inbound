    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="px-6 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl text-gray-900 mb-8">Terms of Service</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                These Terms of Service ("Terms") constitute a legally binding agreement between you and EXON ENTERPRISE LLC 
                ("Company," "we," "our," or "us") concerning your access to and use of the Inbound email receiving service (the "Service").
              </p>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700">
                ...
                <li>Send or receive spam, unsolicited emails, or malicious content</li>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Domain Verification and Ownership</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                To use the Service, you must verify ownership of the domains you wish to configure. You represent and warrant that:
              </p>
              <ul className="list-disc pl-6 text-gray-700">
                <li>You own or have authorization to configure the domains</li>
                <li>You will maintain proper DNS configurations</li>
                <li>You will not configure domains you do not own or control</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Certain features of the Service require payment. By purchasing a paid plan:
              </p>
              <ul className="list-disc pl-6 text-gray-700">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                The Service and its content are owned by EXON ENTERPRISE LLC and protected by intellectual property laws. You agree that:
              </p>
              <ul className="list-disc pl-6 text-gray-700">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                You agree to indemnify and hold harmless EXON ENTERPRISE LLC from any claims, damages, or expenses 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mt-4">
                You may terminate your account at any time through the Service dashboard.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                We may modify these Terms at any time. Material changes will be communicated via email or through the Service. 
