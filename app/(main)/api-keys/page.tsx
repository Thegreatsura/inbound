            ...
            <div className="max-w-6xl mx-auto p-4">
              <div className="bg-card border-border rounded-xl p-8">
                <div className="text-center">
                  <Key2 width="48" height="48" className="text-muted-foreground mx-auto mb-4" />
                  <h3 className="text-lg font-semibold mb-2 text-foreground">No API keys found</h3>
                  ...
                  >
                    ...
                    <div className="flex-shrink-0">
                      <div className="relative p-[8px] rounded-md bg-muted">
                        <Key2 width="23" height="23" className="text-[#735ACF]" />
                        <div className="absolute -top-1 -right-1">{getApiKeyStatusDot(apiKey)}</div>
                      </div>
                    </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {apiKey.remaining !== null && (
                          <>
                            ...
                            <span className="text-xs opacity-60">{apiKey.remaining.toLocaleString()} remaining</span>
                          </>
                        )}
                      </div>
