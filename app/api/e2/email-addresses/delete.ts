...
export const deleteEmailAddress = new Elysia().delete(
  ...
  async ({ request, params, set }) => {
    ...
    console.log(
      "🔍 Getting other email addresses for domain:",
    ...
    console.log(
      "📊 Remaining email addresses after deletion:",
      remainingEmailAddresses.length
    );
    ...
    console.log(
      "ℹ️ Using batch catch-all rules - no SES rule update needed for individual email deletion"
    );
    ...
    console.log(
      "✅ DELETE /api/e2/email-addresses/:id - Successfully deleted email address"
    );
    return response;
  },
  {
