...
<Tip>
The `verifyWebhookFromHeaders` function automatically fetches your endpoint configuration from the API and compares the verification token. For more details, see the [Security guide](/security).
</Tip>
