...
async function handleSupportEmail(email: InboundEmail) {
...
async function handleSalesEmail(email: InboundEmail) {
...
async function handleUnsubscribeEmail(email: InboundEmail) {
...
async function handleGeneralEmail(email: InboundEmail) {
